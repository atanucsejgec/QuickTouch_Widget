...
/**
 * Developer Options shortcut widget.
 * Opens the developer options settings page when tapped.
 */
class DevOptionsWidget : BaseWidget() {
...
private fun DevOptionsContent() {
    Box(
        modifier = GlanceModifier
            ...
            .cornerRadius(16.dp)
            .clickable(onClick = actionRunCallback<DevOptionsAction>()),
        ...
        Column(
            ...
            Image(
                provider = ImageProvider(R.drawable.ic_dev_options),
